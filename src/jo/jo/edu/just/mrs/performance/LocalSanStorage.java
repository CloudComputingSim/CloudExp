...
public class LocalSanStorage extends HarddriveStorage {

    //owner host mashine id
    int ownerID = 0;
    /**
     * The bandwidth.
     */
     ...
     */
    public LocalSanStorage(int ownerID, double capacity, double bandwidth, double networkLatency) throws ParameterException {
        super(capacity);
     ...
     * @throws ParameterException when the name and the capacity are not valid
     */
    public LocalSanStorage(String name, double capacity, double bandwidth, double networkLatency)
     ...
     * the file can also be found using {@link gridsim.datagrid.File#getTransactionTime()}.
     *

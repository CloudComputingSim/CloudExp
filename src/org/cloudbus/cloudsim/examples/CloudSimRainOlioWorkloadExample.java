...
import org.cloudbus.cloudsim.util.RainOlioWorkload;
 ...
 * cloudlet on it.
 */
public class CloudSimRainOlioWorkloadExample {
	...
	Log.printLine("Starting CloudSimRainOlioWorkloadExample...");
	...
	try {
	    ...
	    RainOlioWorkload rainOlioWorkload = new RainOlioWorkload("rain.config.olio.json", 1);
	    cloudletList = rainOlioWorkload.generateWorkload().subList(0, 1000);

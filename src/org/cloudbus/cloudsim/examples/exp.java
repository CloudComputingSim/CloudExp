...
/**
 *
 * @author Zakarea Al-Shara (Zakarea.alshara@gmail.com)
 */
public class exp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create VM
			NetworkVm vm = new NetworkVm(vmid, brokerId, mips, pesNumber, ram, bw, size, vmm, new NetworkCloudletSpaceSharedScheduler());
			...
			NetworkCloudlet cloudlet = new NetworkCloudlet(id, length, pesNumber, fileSize, outputSize, 512, utilizationModel, utilizationModel, utilizationModel);

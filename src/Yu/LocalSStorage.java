...
public class LocalSStorage extends HarddriveStorage {
     ...
     */
    public LocalSStorage(int ownerID, double capacity, double bandwidth, double networkLatency) throws ParameterException {
        super(capacity);
     ...
     * @throws ParameterException when the name and the capacity are not valid
     */
    public LocalSStorage(String name, double capacity, double bandwidth, double networkLatency)

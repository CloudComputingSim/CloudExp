...
public class Results {
     ...
     */
    public static void printResults(List<Vm> vms,double lastClock) {
        Log.enable();
...
//        }
     ...
     */
    public static void printCloudletList(List<Task> taskList) {
...
//    private static void updateJob( Task task) {
